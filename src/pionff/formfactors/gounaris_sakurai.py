...
def gamma_width(e, m_pi, m_rho, g_ppr): #   eq. 115 of https://arxiv.org/pdf/2002.12347.pdf
...
def cmplx_Fpi(e, m_pi, m_rho, g_ppr):
    ...
    den = mSquare(e, m_pi, m_rho, g_ppr) - e**2 - (1j * gamma_width(e, m_pi, m_rho, g_ppr) * m_rho)
    return res / den
